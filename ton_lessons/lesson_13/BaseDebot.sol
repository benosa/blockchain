...
abstract contract BaseDebot  is Debot, Upgradable {

    bytes m_icon;

    TvmCell m_todoCode; // contract code
    TvmCell m_todoData; // contract code
    ...
    function deploy() private view {
            ...
            TvmCell deployMsg = tvm.buildExtMsg({
                ...
                pubkey: none,
                stateInit: image,
                call: {AListPurchase, m_masterPubKey}
            });
    ...
    function _getStat(uint32 answerId) virtual internal view;

    function setStat(Stat stat) virtual public;
